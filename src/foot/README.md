...
<h1 align="center">Everblush for <a href="https://codeberg.org/dnkl/foot">Foot</a></h1>

<h4 align="center"><i>A dark, vibrant, and beautiful color scheme for Foot.</i></h4>
...
Download the `Everblush.ini` file from this folder, and copy the contents of the file to your `foot` config file (usually present at `~/.config/foot/foot.ini`)
