...
<h1 align="center">Everblush for <a href="https://github.com/endaaman/tym">Tym</a></h1>

<h4 align="center"><i>A dark, vibrant, and beautiful color scheme for Tym.</i></h4>
...
Download the `theme.lua` from this directory and paste it in the `~/.config/tym` folder.
